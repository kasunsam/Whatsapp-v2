<template>
  <div class="ml-[420px] w-full fullview">
    <div class="w-full">
      <div id="BG"></div>
      <div class="border-l border-green-500 w-full">
        <div
          class="bg-[#F0F0F0] fixed z-10 min-w-[calc(100vw-420px)] flex justify-between items-center px-2 py-2 messageview"
        >
      ...
      <div
        class="w-[calc(100vw-420px)] p-2.5 z-10 bg-[#F0F0F0] fixed bottom-0 messageBottom"
      >
...
<style>
#BG {
  background: url('/message-bg.png') repeat center;
  width: 100%;
  height: 100%;
  position: fixed;
  z-index: -1;
